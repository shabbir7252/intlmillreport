...
namespace Cash_Register.Controllers
{
    public class CashRegisterController : Controller
    {
        ...
        {
            if (Request.Cookies["locationId"].Value == null)
            {
                return -30;
            }
        ...
        {
            if(Request.Cookies["CRLocationEn"].Value == null || 
                Request.Cookies["CRLocationAr"].Value == null || 
                Request.Cookies["locationId"].Value == null)
            {
                return RedirectToAction("Index", "Home");
            }
